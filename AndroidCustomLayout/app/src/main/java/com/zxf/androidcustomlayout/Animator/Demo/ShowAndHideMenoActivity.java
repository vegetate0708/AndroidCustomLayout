...
public class ShowAndHideMenoActivity extends Activity implements View.OnClickListener{
    private static final String TAG = "ShowAndHideMenoActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showandhidemenu);
        initView();
    }
...
//        double degree = Math.PI/ ((total - 1) * 2)  * index;
    ...
    private void doAnimateClose(final View view, int index, int total,
        ...
        //Math.PI不仅表示圆周率，也表示180度所对应的弧度。所以Math.toRadians(90)就等于Math.PI/2
